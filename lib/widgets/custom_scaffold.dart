...
import 'package:empresas_filtros_ej7/widgets/logo.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor:
            theme.colorScheme.primary, // Color de fondo del AppBar.
        elevation: 0, // Sin sombra debajo del AppBar.
        actions:
            actions, // Acciones opcionales en el AppBar (íconos, botones, etc.).
